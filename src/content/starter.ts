import type { LessonCore } from '../curriculum-types'

// Published v1 task, hint, and checklist contracts remain stable for saved sessions.
export const starterLessons: LessonCore[] = [
  {
